@{
    ...
    FunctionsToExport = @('Add-GraphLargeFile','Get-GraphAuthorizationHeader','Get-GraphData','Invoke-GraphBatch','Invoke-GraphWithRetry','New-GraphBatchRequest','New-GraphUri','Set-GraphAadFactory','Set-GraphAiLogger','Set-GraphBaseUri','Set-GraphScopes')
    CmdletsToExport = @()
    VariablesToExport = @()
    AliasesToExport = @()
